    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: () => import('@/features/knowledge/views/KnowledgeManagementView.vue'),
          meta: {
            title: '知识库管理',
            requiredAnyRoles: [APP_ROLE.platformAdministrator, APP_ROLE.tenantAdministrator],
            requiredAnyPermissions: [
              APP_PERMISSION.knowledgeProfileManage,
              APP_PERMISSION.knowledgeDocumentManage,
              APP_PERMISSION.knowledgeIngestionRead,
              APP_PERMISSION.knowledgeScopeManage,
            ],
            navigation: { label: '知识库', icon: 'agents', order: 47 },
          },
        },
        {

...
export const APP_PERMISSION = {
  ...
  knowledgeProfileManage: 'knowledge:profile:manage',
  knowledgeProfileRead: 'knowledge:profile:read',
  knowledgeDocumentManage: 'knowledge:document:manage',
  knowledgeIngestionRead: 'knowledge:ingestion:read',
  knowledgeScopeManage: 'knowledge:scope:manage',
} as const

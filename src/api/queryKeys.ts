...
export const queryKeys = {
  ...
  knowledgeProfiles: (
    ...
    [...tenantScope(tenantCode), 'knowledge-profiles', pageNum, pageSize, keyword, status] as const,
  knowledgeJobs: (tenantCode: string, pageNum: number, pageSize: number, status: string) =>
    [...tenantScope(tenantCode), 'knowledge-jobs', pageNum, pageSize, status] as const,
}
